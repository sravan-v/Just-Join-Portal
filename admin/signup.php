...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM data_managers WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO data_managers (username, password) VALUES (?, ?)";
...
<body class="loginBG">
    <div class="signup-form">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-blue btn-md btn-block" value="Register Now" />
            </div>
        </form>
        <div class="text-center colorWhite">Already have an account? <a href="login.php">Sign in</a></div>
    </div>
</body>
</html>