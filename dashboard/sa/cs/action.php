...
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "insert")
 {
  ...
  $query = "INSERT INTO cs_images (name, img_id) VALUES ('$file', '$id')";
 ...
 if($_POST["action"] == "update")
 {
  ...
  $query = "UPDATE cs_images SET name = '$file2' WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($conn, $query))
  {
 ...
 {
  $query = "DELETE FROM cs_images WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($conn, $query))
  {
